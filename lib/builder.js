...
module.exports = class Builder {
  ...
  buildHeimdallTree(outputNodeWrapper) {
    ...
    const traverseTree = function traverseTree(nodeWrapper) {
      let heimdallNode = heimdallByBroccoliId[nodeWrapper.id];
      ...
      for (let inputNodeWrapper of nodeWrapper.inputNodeWrappers) {
        ...
        heimdallNode.stats.time.self += traverseTree(inputNodeWrapper);
      }
    ...
    heimdallRootNode.stats.time.self = traverseTree(outputNodeWrapper);
  }
